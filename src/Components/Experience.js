            ...
            <div className='exp-container'>
                <div className='card' style={{ width: '25rem' }}>
                    ...
                    <div className='card-body'>
                        <p><h5>September 2022 to Present</h5></p><br />
                ...
                <div className='card' style={{ width: '25rem' }}>
                    ...
                    <div className='card-body'>
                        <p><h5>July 2019 to April 2021 - Project Accountant</h5></p>
                ...
                <div className='card' style={{ width: '25rem' }}>
                    ...
                    <div className='card-body'>
                        <p><h5>April 2018 to June 2019 - Asst. Project Accountant</h5></p>
                ...
                <div className='card' style={{ width: '25rem' }}>
                    <img src={workIcon1} className="card-img-top" alt="work" />
                    <div className='card-body'>
                        <p><h5>August 2017 to March 2018 - Asst. Project Accountant</h5></p>
                        <p>Larsen & Toubro Saudi Arabia LLC</p>
                ...
                <div className='card' style={{ width: '25rem' }}>
                    <img src={workIcon} className="card-img-top" alt="work" />
                    <div className='card-body'>
                        <p><h5>October 2014 to July 2017 - Asst. Project Accountant</h5></p>
                        <p>Larsen & Toubro Saudi Arabia LLC</p>
                ...
                <div className='card' style={{ width: '25rem' }}>
                    ...
                    <div className='card-body'>
                        <p><h5>July 2013 to September 2014 - Graduate Commercial Trainee</h5></p>
                        <p>Larsen & Toubro Ltd</p>
